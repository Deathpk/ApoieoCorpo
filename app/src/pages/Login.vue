                ...
                <div id="middle-screen" class="col-12 col-md-6 col-lg-4 col-xl-2">
                    <form v-on:submit.prevent="login">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model="password" type="password" class="form-control box-shadow" id="exampleInputPassword1" placeholder="Senha">
                        </div>
                        <div class="form-group d-block d-md-flex d-xl-block mt-5">
                            <div class="col-md-6 col-xl-12 mb-3">
                                <button class="btn btn-blue text-uppercase text-green font-weight-bold w-100">
                                    <router-link to="/register" class="text-uppercase text-white font-weight-bold">Cadastrar</router-link>
                                </button>
                            </div>
                            <div class="col-md-6 col-xl-12">
                                <button class="btn btn-blue-border-radius text-uppercase text-blue font-weight-bold w-100">Entrar</button>
                            </div>
                            <div class="col-md-12 float-right text-right text-decoration-underline mt-2">
                                <a href="/forgot" class="text-blue">Esqueceu sua senha?</a>
                            </div>
                        </div>
                    </form>
                </div>
